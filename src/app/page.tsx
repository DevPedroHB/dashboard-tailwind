  ...
  return (
    <>
      ...
      <div className="mt-6 flex flex-col">
        ...
        >
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-from">
            <label
              htmlFor="first-name"
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              <Input.Root>
                <Input.Control id="first-name" defaultValue="Pedro" />
              </Input.Root>
              <div className="flex flex-col gap-3 lg:block">
                ...
                <Input.Root>
                  <Input.Control id="last-name" defaultValue="Henrique" />
                </Input.Root>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-from">
            <label
              htmlFor="email"
              className="text-sm font-medium text-zinc-700"
            >
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="pedroh.bergamo20@gmail.com"
              />
            </Input.Root>
          </div>
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-from">
